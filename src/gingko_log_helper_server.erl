...
-module(gingko_log_helper_server).
...
init([]) ->
    gingko_log_helper_vnode:init([0]).

handle_call(Request, {Pid, _Tag}, State) ->
    gingko_log_helper_vnode:handle_command(Request, {raw, undefined, Pid}, State).
...
terminate(Reason, State) ->
    gingko_log_helper_vnode:terminate(Reason, State).
